...
def __train(weight_init_std):
    bn_network = MultiLayerNet(784, [100, 100, 100, 100], 10, weight_init_std)
    network = MultiLayerNet2(784, [100, 100, 100, 100], 10, weight_init_std)
    ...
    for i in range(1000000000):
        ...
        for _network in (bn_network, network):
            ...
            _network.backward(x_batch, t_batch)
            params, grads = _network.params, _network.grads

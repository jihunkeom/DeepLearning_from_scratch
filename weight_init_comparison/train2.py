...
from model import MultiLayerNet2
...
models = {
    0.01: MultiLayerNet2(784, [100, 100, 100, 100], 10, 0.01),
    "he": MultiLayerNet2(784, [100, 100, 100, 100], 10, "he"),
    "xavier": MultiLayerNet2(784, [100, 100, 100, 100], 10, "xavier")
